...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record5<Integer, String, Integer, Boolean, Integer> {
    ...
    @Override
    public Row5<Integer, String, Integer, Boolean, Integer> valuesRow() {
    ...
    @Override
    public MessageRecord values(Integer value1, String value2, Integer value3, Boolean value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageRecord(Integer id, String content, Integer receiver, Boolean sent, Integer sender) {
        super(MessageJ.MESSAGE);
